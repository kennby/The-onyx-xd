...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ 𝚔𝚎𝚗𝚗 ] 𝚊𝚍𝚟𝚎𝚛𝚝𝚎𝚗𝚌𝚒𝚊*', body: '𝙾𝙽𝚈𝚇 𝙱𝙾𝚃', thumbnail: imagen1, sourceUrl: 'https://github.com/kennn/onyxx'}}}}, aa);
